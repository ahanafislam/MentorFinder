...
SECRET_KEY = '6%@(+&nwa*8vy=)b=2dp=7=8a&^0pc*-mg65fh0@snkghib*eu'
...
ROOT_URLCONF = 'mentorFinder.urls'
...
WSGI_APPLICATION = 'mentorFinder.wsgi.application'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "mentorFinder/static"),
]
